...
ppixiv.on_click_viewer = class
{
    ...
    set_new_image = async(signal, {
        ...
        // If true, we're in autoplay mode.  We'll always start an animation, and image
    ...
    }={}) =>
    {
        ...
        // Don't show low-res previews in autoplay.
        if(autoplay)
            preview_url = url;
    ...
    reset_position()
    {
        ...
        if(ppixiv.settings.get("auto_pan") || this.autoplay)
        {
    ...
    pointerevent = (e) =>
    {
        if(e.mouseButton != 0 || this.autoplay)
            return;
    ...
    refresh_autopan()
    {
        ...
        let pan_duration = this.autoplay? 30:3;
        ...
        */
        ...
        this.run_animation(this.autoplay? default_pan_with_fade:default_pan);
    }
